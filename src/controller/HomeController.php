...
class HomeController extends Controller
{
    ...
    public function index(): ?Element
    {
        ...
        return new PageContent(
            new h1(classes: ['primary-color'], content: 'Scratchy Website Template'),
            ...
            new h3(classes: ['mt-4'], content: 'What you can build'),
            $features,
            new p(
            ...
            new h3(classes: ['mt-4'], content: 'How data is handled'),
            new p(
